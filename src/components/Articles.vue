            ...
            >
              ...
              <v-card>
                ...
                <!--    <div v-if="item.report_events[0].location.city && item.report_events[0].location.country"> Location : {{ item.report_events[0].location + "," + item.report_events[0].location}} </div> -->
                  ...
                  {{ details }}
                <v-img :src="chart"  aspect-ratio=""> </v-img>
                </v-card-text>
                <div>
                  <v-toolbar
                    dense
...
export default {
  ...
  methods: {
    attract: function (Obj) {
      ...
      this.start_date = Obj.report_events[0].start_date.substring(0, 10) + ' ' +
      Obj.report_events[0].start_date.substring(11, 19)
      this.location = Obj.report_events[0].location.city + ', ' +
    ...
    getData: function () {
      this.url = this.url + this.$route.params.start + 'T00:00:00&end_date=' +
      this.$route.params.end + 'T00:00:00'
